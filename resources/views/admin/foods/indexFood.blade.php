                        ...
                        <div
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                    @forelse ($foods as $index=> $row)
                                        <tr>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $index + $foods->firstItem() }}</span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
                                            ...
                                            <td class="h-px w-72 whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $row->category_id }}</span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-1.5 flex gap-2">
                                                    <a href="{{ route('foods.edit', $row->id) }}"
                                                    ...
                                                    <form onsubmit="return confirm('are you sure?')" method="POST"
                                                        action="{{ route('foods.destroy', $row->id) }}">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit"
